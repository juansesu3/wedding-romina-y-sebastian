            ...
            {[
                {
                    ...
                    link:
                        'https://open.spotify.com/playlist/6kJUqsTHTe80nIPJ5VD6pw?si=MX8w0kfiT66jkdaW6vDsAw&pi=zCswFsG6T_iPa&pt=574511dc913c5245a161358b2b85013b'
                },
                {
                ...
                <FadeInOnScroll key={idx}>
                    <section className="py-12 bg-[#faf6f3] text-center px-4">
                        <div className="flex flex-col items-center gap-4">
                            ...
                            {link ? (
                                <a href={link} target="_blank" rel="noopener noreferrer" className="btn-primary mt-6">
                                    {button}
                                </a>
                            ) : (
